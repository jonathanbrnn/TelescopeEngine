...
class ColliderVisualizer : public GameObject {
    ColliderVisualizer(SDL_Renderer* renderer, string name, float pos_x = 0, float pos_y = 0, float pos_z = 0, float width = 1,
        float height = 1, float rotation = 0, string texture_filepath = "/Users/admin/TelescopeEngine/media/asesprite/collidervisualizer.png") : GameObject(renderer, name, pos_x, pos_y, pos_z, width, height, rotation, texture_filepath) {}
